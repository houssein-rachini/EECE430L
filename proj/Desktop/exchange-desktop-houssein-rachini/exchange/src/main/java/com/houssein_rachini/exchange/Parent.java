...
public class Parent implements Initializable, OnPageCompleteListener {
    ...
    private enum Section {
        ...
        public String getResource() {
            return switch (this) {
                case RATES ->
                        "/com/houssein_rachini/exchange/rates/rates.fxml";
                case TRANSACTIONS ->
                        "/com/houssein_rachini/exchange/transactions/transactions.fxml";
                case LOGIN ->
                        "/com/houssein_rachini/exchange/login/login.fxml";
                case REGISTER ->
                        "/com/houssein_rachini/exchange/register/register.fxml";
                default -> null;
            };
        }
